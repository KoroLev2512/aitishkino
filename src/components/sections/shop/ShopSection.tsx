    ...
    <section className={styles.shopSection}>
      <div className={styles.container}>
        ...
        <p className={styles.description}>
          В АйтиШоп мы ценим твои успехи! За каждый пройденный урок, выполненное задание и участие в мероприятиях ты 
          получаешь баллы, которые можно обменять на что-то полезное в нашем магазине IT-бонусов. Мотивация и 
          вознаграждение ждут тебя!
        </p>
      </div>
